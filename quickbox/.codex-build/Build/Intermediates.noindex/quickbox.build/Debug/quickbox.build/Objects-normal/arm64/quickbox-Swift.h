...
#ifndef QUICKBOX_SWIFT_H
#define QUICKBOX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="quickbox",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8quickbox11AppDelegate")
...
SWIFT_CLASS("_TtC8quickbox17MenuBarController")
...
@class NSCoder;
@class NSWindow;
SWIFT_CLASS("_TtC8quickbox24SettingsWindowController")
